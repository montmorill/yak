...
declare global {
  namespace JSX {
    interface IntrinsicElements extends Resource.Definitions {}
  }
}
...
export namespace Resource {
  ...
  //   const element = new Element(type, pick(data, resource.attrs as any), [])
  ...
  // export function decode(element: Element<keyof Definitions>) {
...
//     if (key.startsWith('_') || key === 'referrer')
//       return [key, value]
